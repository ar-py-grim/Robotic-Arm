...
def generate_launch_description():
    ...
    plugin_path = os.path.join(get_package_prefix('ros2_linkattacher'), 'lib')
    env_plugin = SetEnvironmentVariable('GAZEBO_PLUGIN_PATH', plugin_path)

    world = os.path.join(arm_description_dir, 'worlds', 'pick_place_scene.world')
